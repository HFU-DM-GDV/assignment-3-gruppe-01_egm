...
def create_hybrid_image(img_1, img_2, cutoff_freq_img_1, cutoff_freq_img_2):
    ...
    img_result = hybrid_image(
        img_1, img_2, cutoff_freq_img_1, cutoff_freq_img_2)
    ...
    cv2.setWindowProperty("Result big (high frequencies)",
                          cv2.WND_PROP_TOPMOST, 1)
    cv2.setWindowProperty("Result small (low frequencies)",
                          cv2.WND_PROP_TOPMOST, 1)
